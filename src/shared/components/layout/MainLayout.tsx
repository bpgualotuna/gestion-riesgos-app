      ...
      <Box
        ...
        >
            ...
            {!esAdmin && !esSupervisorRiesgos && (
              ...
              >
                {/* Selector de Proceso - Botón naranja con dropdown */}
                <FormControl size="small" sx={{ minWidth: 180 }}>
                  <Select
                    ...
                    renderValue={(value) => {
                      if (!value && !procesoSeleccionado) {
                        return 'Seleccionar Proceso';
                      }
                      const proceso = value 
                        ? procesosDisponibles.find((p) => p.id === value) 
                        : procesoSeleccionado;
                      // Mostrar primero el área, luego el proceso si no hay área
                      if (proceso) {
                        return proceso.areaNombre || proceso.nombre || 'Seleccionar Proceso';
                      }
                      return 'Seleccionar Proceso';
                    }}
                  >
                ...
                {/* Selector de Modo - Botón naranja con dropdown */}
                <FormControl size="small" sx={{ minWidth: 150 }}>
                  <Select
                    ...
                    onChange={(e) => {
                      ...
                      if (!procesoSeleccionado && nuevoModo !== '') {
                        showError('Debe seleccionar un proceso primero');
                        return;
                      }
                      if (nuevoModo === '') {
                        setModoProceso(null);
                    ...
                    renderValue={(value) => {
                      ...
                      return value === 'editar' ? 'Edición' : 'Visualización';
                    }}
                  >
