...
// URL Base de API (configurar según entorno)
// Nota: La aplicación actualmente usa solo datos mock (localStorage)
export const URL_BASE_API = import.meta.env.VITE_API_BASE_URL || '';

// Configuración de Paginación
export const PAGINACION = {
  TAMANO_PAGINA_POR_DEFECTO: 10,
  OPCIONES_TAMANO_PAGINA: [5, 10, 25, 50, 100],
} as const;
